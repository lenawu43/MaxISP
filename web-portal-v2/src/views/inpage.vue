<template>
  <el-container direction="vertical">
    <vue-header :title="headerTitle"></vue-header>
    <el-container :class="'inpage-container'">
      <el-aside :style="{'height': $store.getters.mainHeight + 'px', 'min-width': '65px', 'width': 'auto','overflow': 'visible'}">
        <el-row class="tac">
          <el-col :span="24">
...
export default {
  ...
  created(){
     this.headerTitle=sessionStorage.getItem('groupName');  
  },
  computed: {
    menuTags() {   
