        ...
        <div class="loginleft">
           <lang-select></lang-select>          
            <h1 class="login-title">
              <img style="width:724px;height:102px" src="@/assets/images/logotype_maxcloud.png" alt="logo">
            </h1>           
            <el-form :model="loginForm" :show-message="false" status-icon :rules="rules2" 
              ...
              <el-form-item ref="code" prop="code" label-width="0px" style="margin-bottom: 5px;">
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      home_logo(){
         return this.$store.getters.dataResource["home_logo"]||'home_logo';
      }
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            this.$store.dispatch('LoginByUsername', {
              ...
              // debugger
              /* request({
                url: '/admin/application-system/lastApplicationSystemByUserId'
              }).then(response => {
                // debugger
                if (response.data && response.data.url) {
                  window.location.href = response.data.url;
                  // this.$router.push({ path: response.data.url }); //登录成功之后重定向到首页
                } else {
              ...
              /* let lastUrl = Cookies.get('Last-url');
              if(lastUrl) {
