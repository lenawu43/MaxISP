        ...
        <li>
          <el-dropdown @command="handleCommand">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item command="changePwd">{{langText.form.update + '' + langText.login.password}}</el-dropdown-item>
              <el-dropdown-item command="logout">{{langText.login.logout}}</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </li>
      </ul>
